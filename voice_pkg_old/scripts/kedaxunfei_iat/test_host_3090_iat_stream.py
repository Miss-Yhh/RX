...
class Ws_Param(object):
		# 初始化
		def __init__(self, APPID, APIKey=None, APISecret=None):
				self.APPID = APPID
				self.APIKey = APIKey
...
def kedaxunfei_iat_service():
		...
		def get_buf(resetFlag, endFlag, buf):
			d = {
					"sessionParams":{
				...
				def run(*args):
					...
					while step < total_frames:
							...
							if len(buffers) == 1 and status == STATUS_FIRST_FRAME:
									...
									d = get_buf(resetFlag, endFlag, buf)
...
if __name__ == "__main__":
		...
		# print('res1 = ', res)
		time1 = datetime.now()
		# kedaxunfei_iat_service('/home/kuavo/catkin_dt/src/voice_pkg/scripts/funasr_asr/output_3090.wav')
		time2 = datetime.now()
		# print(time2-time1)
		a = {
				"sessionParams":{
