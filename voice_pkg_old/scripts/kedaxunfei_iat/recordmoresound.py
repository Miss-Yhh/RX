...
def iat_web_api():
    ...
    date_list = [nowtime.year, nowtime.month, nowtime.day, nowtime.hour, nowtime.minute, nowtime.second]
    date_list = [str(s) for s in date_list]
    nowtime = "_".join(date_list)

    savepath_noise = f'/home/kuavo/catkin_dt/src/voice_pkg/scripts/kedaxunfei_iat/audiotext4finetune/{nowtime}_noise.wav'
    savepath = f'/home/kuavo/catkin_dt/src/voice_pkg/scripts/kedaxunfei_iat/audiotext4finetune/{nowtime}.wav'

    proc1 = subprocess.Popen(['python3', '/home/kuavo/catkin_dt/src/voice_pkg/scripts/kedaxunfei_iat/get_mic_from_head.py', savepath_noise, nowtime])
    proc2 = subprocess.Popen(['python3', '/home/kuavo/catkin_dt/src/voice_pkg/scripts/kedaxunfei_iat/get_mic_from_audio.py', savepath, nowtime])
