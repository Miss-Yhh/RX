...
if __name__ == "__main__":
    ...
    '''
python /home/kuavo/catkin_dt/src/voice_pkg/scripts/kedaxunfei_tts/test_host_3090_tts.py '你好' /home/kuavo/catkin_dt/src/voice_pkg/scripts/kedaxunfei_tts/test_wav.wav
    '''
    # text = '這是一個很長的文本很長很長的'
