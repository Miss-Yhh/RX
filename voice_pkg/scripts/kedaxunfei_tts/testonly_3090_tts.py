...
if __name__ == "__main__":
    text = "大家有什么问题吗？"
    # savepath = sys.argv[2]
    savepath = '/home/kuavo/catkin_dt/src/voice_pkg/scripts/kedaxunfei_tts/anybodyquestions.wav'
    # with open('/home/kuavo/catkin_dt/src/voice_pkg/scripts/kedaxunfei_tts/duoyin.json', 'r+', encoding='utf-8') as fj:
    #     jsondata = json.load(fj)
    ...
    # text = '這是一個很長的文本很長很長的'
    # savepath = '/home/kuavo/catkin_dt/src/voice_pkg/scripts/kedaxunfei_tts/testtest.wav'
    # time1 = datetime.now()
    # get_tts(text, savepath)
    # time2 = datetime.now()
    # print(time2 - time1)
